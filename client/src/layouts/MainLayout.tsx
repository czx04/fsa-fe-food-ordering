    ...
    <div className="min-h-screen flex flex-col bg-slate-50/40 text-slate-800 font-sans">
      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-slate-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <Link to="/" className="text-2xl font-black tracking-tight text-orange-600 hover:opacity-90 transition">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-semibold text-slate-600">
              <NavLink 
                to="/home" 
                className={({ isActive }) => 
                  isActive ? "text-orange-600 font-bold" : "hover:text-orange-600 transition"
                }
              >
                Trang chủ
              </NavLink>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            {isAuthenticated ? (
              <div className="flex items-center gap-3">
                <Link to="/cart" className="p-2 rounded-xl hover:bg-slate-100 text-slate-700 relative transition" title="Giỏ hàng">
      ...
      <footer className="bg-white border-t border-slate-100 py-12 text-slate-500 text-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-800 mb-3">Khám phá</h4>
            <ul className="space-y-2 text-xs">
              <li><Link to="/restaurants" className="hover:text-orange-600 transition">Nhà hàng gần bạn</Link></li>
              <li><Link to="/restaurants?category=mon-hot" className="hover:text-orange-600 transition">Món hot hôm nay</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-800 mb-3">Dịch vụ</h4>
            <ul className="space-y-2 text-xs">
              <li><Link to="/profile" className="hover:text-orange-600 transition">Tài khoản cá nhân</Link></li>
              <li><Link to="/orders" className="hover:text-orange-600 transition">Lịch sử đơn hàng</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-800 mb-3">Hỗ trợ</h4>
            <p className="text-xs text-slate-400">Hotline: 1900 8888</p>
            <p className="text-xs text-slate-400 mt-1">Email: hotro@mammam.vn</p>
          </div>
        </div>
