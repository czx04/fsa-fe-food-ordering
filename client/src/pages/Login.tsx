    ...
    <main className="auth-page">
      <section className="auth-art">
        ...
        <div className="center">
          ...
          <p className="muted">Hơn 1.000 nhà hàng, hàng ngàn lựa chọn mỗi ngày.</p>
        </div>
      ...
      <section className="auth-form-wrap">
        <form className="auth-form" onSubmit={handleLogin}>
          ...
          <p className="muted">Đăng nhập để tiếp tục hành trình ẩm thực của bạn.</p>
          ...
          <div className="field">
            <div className="password-line">
              ...
              <Link className="link caption" to="/forgot-password">Quên mật khẩu?</Link>
            </div>
            <input 
              type="password" 
              value={password}
          ...
          <div className="social-login">
            <button type="button" className="btn btn-outline">G Google</button>
            <button type="button" className="btn btn-outline">● Facebook</button>
          </div>
          
          <p className="center muted" style={{ marginTop: '24px' }}>
            Chưa có tài khoản? <Link className="link" to="/register">Đăng ký ngay</Link>
          </p>
        </form>
      </section>
    </main>
