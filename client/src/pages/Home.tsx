      ...
      <section className="hero">
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <h1>
              Đói bụng ư? Món ngon <span>đến liền!</span>
            </h1>
            <p>
          ...
          <div className="hero-art">
            ...
            <div className="float-card one">
              ...
              <span>
                Giao siêu tốc
                <br />
                <small className="muted">Chỉ từ 20 phút</small>
              </span>
            </div>
            <div className="float-card two">
              ...
              <span>
                4.9/5
                <br />
                <small className="muted">12k+ đánh giá</small>
              </span>
            </div>
            <div className="float-card three">
              ...
              <span>
                FREESHIP
                <br />
                <small className="muted">Đơn từ 99k</small>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="promo">
            <div>
              ...
              <p className="muted">
                Nhập mã <b>HELLOMAM</b> và tận hưởng bữa ăn ngon hơn với giá mềm
                hơn.
              </p>
              <Link className="btn" to="/restaurants">
                Đặt món ngay
                ...
                <article className="restaurant-card" key={r._id}>
                  ...
                  <div className="body">
                    ...
                    <div className="foot">
                      ...
                      <Link className="link" to="/restaurant-detail">
                        Xem quán →
                      </Link>
                    </div>
                  </div>
